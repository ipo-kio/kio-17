...
/* harmony export (immutable) */ __webpack_exports__["TaskFmtFirst"] = TaskFmtFirst;
/**
...
/**
 * создаем класс TaskFmtFirst, конструктор может быть пустым, инициализация происходит позже
 ...
 * @constructor
 */
function TaskFmtFirst(settings) {
 ...
 */
TaskFmtFirst.prototype.id = function () {
    return "TaskFmtFirst";
};

TaskFmtFirst.prototype.initCounter=0;
 ...
 */
TaskFmtFirst.prototype.initialize = function (domNode, kioapi, preferredWidth) {
    //сохраняем данные для будущего использования
    this.kioapi = kioapi;
    TaskFmtFirst.prototype.initCounter++;
    $(domNode).attr('id', 'fmtId'+TaskFmtFirst.prototype.initCounter);
    this.fmt.init(kioapi, 'fmtId'+TaskFmtFirst.prototype.initCounter, preferredWidth, JSON.parse('{"input":"2001-ый", "alphabet":"012345-ыйои", "outalphabet":"ийыо", "outfsm":false, "height":500, "vertexsize":25}'));
 ...
 * для сравнения:
 */
TaskFmtFirst.prototype.parameters = function () {
    return [{
 ...
 */
TaskFmtFirst.prototype.solution = function () {
 ...
 */
TaskFmtFirst.prototype.loadSolution = function (solution) {
    if (!solution) return;
 ...
 * }
        ...
        var qwerty00006 = (function () {
            ...
            Fsm.prototype.init = function (kio, divId, taskWidth, config) {
              ...
              this.load(JSON.parse('{"states":[{"id":"v0","x":0.1044681088526111,"y":0.6432350330670378,"final":false,"label":"S0","first":true},{"id":"v1","x":0.1653229397726252,"y":0.3104960734368869,"final":false,"label":"S1","first":false},{"id":"v2","x":0.23792970862755572,"y":0.16392999308922018,"final":false,"label":"S2","first":false},{"id":"v3","x":0.35074945715598627,"y":0.17725418221173536,"final":false,"label":"S3","first":false},{"id":"v4","x":0.46692902400191744,"y":0.18391627677299296,"final":true,"label":"S4","first":false},{"id":"v5","x":0.2625043073169168,"y":0.7668495508830305,"final":false,"label":"S5","first":false},{"id":"v6","x":0.39878162732155564,"y":0.6336076596578792,"final":false,"label":"S6","first":false}],"transitions":[{"from":"v0","to":"v1","label":"0"},{"from":"v1","to":"v2","label":"-"},{"from":"v2","to":"v3","label":"о"},{"from":"v3","to":"v4","label":"й"},{"from":"v0","to":"v5","label":"1"},{"from":"v5","to":"v5","label":"0"},{"from":"v5","to":"v5","label":"1"},{"from":"v5","to":"v6","label":"-"},{"from":"v6","to":"v3","label":"ы"}],"input":"101-ый"}'));
          ...
          Fsm.prototype.submitResult=function(){
            ...
            for (var i = 0; i < this.testw.length; i++) {
              var test = this.testw[i];
              if(!this.calc(test)){
                wrongs++;
              }
            }
            ...
            this.kio.submitResult({
              correct: Math.round((rights/this.testr.length)*(wrongs/this.testw.length)*100*10000000)/10000000,
