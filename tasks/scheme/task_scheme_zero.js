...
/***/ 9:
/* exports provided: TaskSchemeZero */
/* all exports used */
/*!****************************************!*\
...
/* harmony export (immutable) */ __webpack_exports__["TaskSchemeZero"] = TaskSchemeZero;
/**
...
/**
 * создаем класс TaskSchemeZero, конструктор может быть пустым, инициализация происходит позже
 ...
 * @constructor
 */
function TaskSchemeZero(settings) {
 ...
 */
TaskSchemeZero.prototype.id = function () {
    return "TaskSchemeZero";
};

TaskSchemeZero.prototype.initCounter=0;
 ...
 */
TaskSchemeZero.prototype.initialize = function (domNode, kioapi, preferredWidth) {
    //сохраняем данные для будущего использования
    this.kioapi = kioapi;
    TaskSchemeZero.prototype.initCounter++;
    $(domNode).attr('id', 'schemeId'+TaskSchemeZero.prototype.initCounter);
    debugger;
    this.scheme.init(kioapi, 'schemeId'+TaskSchemeZero.prototype.initCounter, preferredWidth, JSON.parse('{ "type": "boolean", "inputNum": 2, "outputNum": 2, "bases": [{ "id": "76", "inputNum": 2, "outputNum": 1,"name": "NOR", "func": "output[0]=+!(input[0]|input[1])"}]}'));
 ...
 * для сравнения:
 */
TaskSchemeZero.prototype.parameters = function () {
    return [{
 ...
 */
TaskSchemeZero.prototype.solution = function () {
 ...
 */
TaskSchemeZero.prototype.loadSolution = function (solution) {
    if (!solution) return;
...
var qwerty00003 = function () {
    ...
    //noinspection all
  Scheme.prototype.layout = '<style>#divId .it-task{background-image:url(/assets/stylesheets/../../~plugin/KioOnline/scheme0.png);background-size:100% 100%}#divId .it-scene{background-image:url(/assets/stylesheets/../../~plugin/KioOnline/scheme0_canvas.png);background-size:100% 100%;border:1px solid #a9a9a9;margin-left:25px;margin-rigth:25px}#divId .top-buffer{margin-top:20px}</style><div class="it-task well"><div class="row"><div class="col-sm-12"><canvas class="it-scene" height="200px"></canvas></div></div><div class="row top-buffer"><div class="col-sm-12"><div class="it-controls"><div class="btn-group" role="group"><button class="it-control-decrease btn btn-default" type="button">Предыдущий входной набор</button> <button class="it-control-increase btn btn-default" type="button">Следующий входной набор</button></div></div></div></div></div>';//###layout
    ...
    Scheme.prototype.init = function (kio, divId, taskWidth, config) {
        ...
        $scene.attr("width", taskWidth - 40-50);
        ...
        this.gui.width = taskWidth - 40-50;
